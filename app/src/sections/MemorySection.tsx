...
const MemorySection = ({ onComplete }: MemorySectionProps) => {
  ...
  const memories: Memory[] = [
    ...
    { 
      year: 2022, 
      title: "新手妈妈的第一个生日", 
      description: "Probably 边喂奶边许愿， chaos也是幸福",
      emoji: "👶",
      color: "#F4AFA8"
    },
    { 
      year: 2023, 
      title: "宝宝会叫妈妈的生日", 
      description: "Chaos中的温暖，那一声妈妈胜过所有",
      emoji: "🗣️",
      color: "#E8B4B8"
    },
    { 
